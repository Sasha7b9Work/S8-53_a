...
outputInterface = open("fontUGO.cs", "w")             # Этот шрифт будет использоваться в клиентской программе на PC
outputInterface.write("namespace ControlLibraryS8_53\n")
outputInterface.write("{\n")
outputInterface.write("\tpartial class Display\n")
outputInterface.write("\t{\n")
outputInterface.write("\t\tprivate void InitFontUGO()\n")
outputInterface.write("\t\t{\n")
outputInterface.write("\t\t\tfonts[2] = new MyFont();\n")
outputInterface.write("\t\t\tMyFont font = fonts[2];\n")
